...
import { REQUIRED, REQUIRED_FIELD } from '@/constants/validateMessages'
...
export const numeric = extend('numeric', {
  // eslint-disable-next-line camelcase
  ...rule_numeric,
  message: 'Vui lòng không nhập dấu chấm',
})

export const currency = extend('currency', {
  // eslint-disable-next-line camelcase
  validate: curency,
  message: 'Vui lòng nhập Tổng mức đầu tư lớn hơn 0',
})

export const maxLengthCode = extend('maxLength', {
  // eslint-disable-next-line camelcase
  validate: maxLength,
...
// eslint-disable-next-line camelcase
export const email = extend('email', { ...rule_email, message: REQUIRED })
